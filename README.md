...
- готово! Отправлять HTTP-запросы к API приложения рекомендуется через Postman, используя готовую [коллекцию](https://documenter.getpostman.com/view/31039387/2sAYBYgqgS#b7a1c559-9a44-4c16-9326-5b53094c8551). 
