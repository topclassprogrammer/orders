...
При первом запуске приложения происходит загрузка первоначальных фикстур в БД - перечень ролей и сам пользователь с ролью администратора. Для получения его логина и пароля, см. файл .env.example.  
